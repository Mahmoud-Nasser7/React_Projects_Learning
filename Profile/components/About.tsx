    ...
    <section className="bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-700">
          Mahmoud   is a talented software engineer with a passion for creating
          ...
          unparalleled. Mahmoud  's diverse skill set has enabled him to build
        ...
        <p className="mt-4 text-lg text-gray-700">
          ...
          apart. Mahmoud  's dedication to honing his skills in this area led him
          ...
          his tireless efforts, Mahmoud   has earned his badge as a truly talented
          UI/UX Designer.
        </p>
      </div>
    </section>
